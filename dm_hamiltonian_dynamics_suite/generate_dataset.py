...
flags.DEFINE_string("folder", None, "The folder where to store the datasets.")
flags.DEFINE_string(
    "dataset",
    None,
    "The dataset from datasets.py to use or " "'molecular_dynamics' respectively.",
)
flags.DEFINE_string(
    "lammps_file",
    None,
...
flags.DEFINE_integer(
    "steps_per_dt",
    10,
    "How many internal steps to do per a single observation " "step.",
)
flags.DEFINE_integer("num_train", None, "The number of training examples to generate.")
flags.DEFINE_integer("num_test", None, "The number of test examples to generate.")
